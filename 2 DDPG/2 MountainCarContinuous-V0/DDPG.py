...
class DDPG(object):
    def __init__(
        ...
        self.var_liner_times = var_liner_times
        self.train = train
    ...
    def _build_a(self, s, scope, trainable):
        ...
        with tf.variable_scope(scope):
            ...
            a = tf.layers.dense(net0, self.a_dim, activation=tf.nn.tanh, name='a', trainable=trainable)
    ...
    def _build_c(self, s, a, scope, trainable):
        ...
        with tf.variable_scope(scope):
            ...
            q = tf.layers.dense(net1, 1, trainable=trainable)  # Q(s,a)
            return q
